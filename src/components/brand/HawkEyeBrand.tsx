...
export const HawkEyeBrand: React.FC<HawkEyeBrandProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`animate-brand-entrance select-none flex items-center transition-all ${
    ...
    >
      ...
      <div className="eye-glint-wrapper shrink-0">
        <img
          src={logoImg}
          alt="hawkEYE Eye Icon"
          className={`object-contain logo-drop-shadow shrink-0 ${
